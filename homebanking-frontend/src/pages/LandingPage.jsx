...
const PRODUCTOS = [
  { icon: PiggyBank, color: '#c70f1b', titulo: 'Cuenta de Ahorros', desc: 'Maneja tu dinero sin costo de mantenimiento y gana intereses todos los días.' },
  { icon: Wallet, color: '#c70f1b', titulo: 'Ahorro Sueldo', desc: 'Recibe tu sueldo, retira sin comisiones y accede a beneficios exclusivos.' },
  { icon: BadgePercent, color: '#c70f1b', titulo: 'Crédito Personal', desc: 'El efectivo que necesitas con tasas preferenciales y cuotas a tu medida.' },
  { icon: Briefcase, color: '#c70f1b', titulo: 'Credipyme', desc: 'Impulsa tu negocio con financiamiento ágil pensado para emprendedores.' },
  { icon: Send, color: '#c70f1b', titulo: 'Transferencias', desc: 'Mueve tu dinero entre tus cuentas al instante, las 24 horas del día.' },
  { icon: CreditCard, color: '#c70f1b', titulo: 'Tarjeta de Débito', desc: 'Paga y compra en todo el país, en tiendas y por internet, con total seguridad.' },
]
...
const BENEFICIOS = [
  ...
  { icon: MapPin, titulo: 'Cobertura nacional', desc: 'Presencia en todo el país con agencias en Tacna y todo el Perú.' },
]
    ...
    <div className="lp-page">
      ...
      <section className="lp-hero">
        <div className="lp-hero-inner">
          <div className="lp-hero-text">
            ...
            <h1>Tu caja municipal,<br />siempre contigo</h1>
            <p>
      ...
      <section className="lp-promo">
        <div className="lp-promo-inner">
          <div>
            ...
            <p>Sin papeleos ni colas. Pide tu crédito de consumo o microempresa desde tu Banca por Internet y recibe una respuesta al instante.</p>
          </div>
          <button className="lp-btn lp-btn-light" onClick={() => navigate('/login')}>
      ...
      <section className="lp-section" id="beneficios">
        <div className="lp-section-head">
          ...
          <p>Una caja municipal cercana, segura y hecha para el Perú.</p>
        </div>
